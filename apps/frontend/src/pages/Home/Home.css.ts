...
export const featureCard = style({
  ...
  position: "relative",
  transition:
    "background .25s, border-color .25s, box-shadow .35s, transform .35s cubic-bezier(0.4,0,0.2,1)",
  selectors: {
    "&:hover": {
...
export const divider = style({
  height: "1px",
  background:
    "linear-gradient(90deg, transparent 0%, rgba(0, 102, 204, 0.08) 50%, transparent 100%)",
  marginTop: "5rem",
  marginBottom: "4rem",
  maxWidth: "80rem",
  marginLeft: "auto",
