import { heroContent, heroSection, heroSubtitle, heroSubtitleEmojis, heroTitle } from '../Home.css.ts';
			...
			<div className={heroContent}>
				...
				{parts && (
					<p className={heroSubtitle}>
						{parts.text}
						{parts.emojis && <span className={heroSubtitleEmojis}>{parts.emojis}</span>}
					</p>
				)}
			</div>
		</section>
